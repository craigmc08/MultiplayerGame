...
module.exports.updateBullet = function updateBullet(b) {
    // Update last position
...
module.exports.generateNewObstacle = function generateNewObstacle(x, y, w, h) {
    return {
        box: new B(new V(x, y), w, h).toPolygon(),
        px: new V(x, y),
        velocity: new V(0, 0),
        hue: Math.random() * 360
    };
...
module.exports.preapreObstacleForClient = function prepareObstacleForClient(o) {
    return {
        x: o.box.pos.x,
        y: o.box.pos.y,
        px: o.lastpos.x,
